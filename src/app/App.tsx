...
export default function App() {
  return (
    <div className="h-screen overflow-y-auto flex items-start justify-center bg-gray-100">
      <StickyHeaderCTA />
      {/* On desktop (md+), scale the 393px column up so it's clearly visible and not squeezed */}
      <div className="scrollbar-thin min-w-[393px] w-full max-w-[393px] md:max-w-[1024px] min-h-0 overflow-x-hidden overflow-y-auto bg-white shadow-xl">
